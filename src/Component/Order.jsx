const Order = ({selectedIndex, formattedDate,quantity,profit,lots,ltp,buy,sell}) =>{
  return(<>
   <div>
      <div className="p-3 mt-3 border-b-2  dark:border-slate-600/50 dark:text-gray-100 text-gray-600 border-gray-200 flex flex-col gap-1">
        ...
        <div className="flex justify-between items-center text-[12px]">
          <div className="flex justify-center items-center gap-1">
            <span className="text-[13px]">{lots}</span>  Lots <i className="fa-solid fa-circle text-[4px]"></i> <span className="bg-gray-200 text-[10px] dark:bg-slate-600">CF</span></div>
          <div>LTP {ltp}</div>
        </div>
